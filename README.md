...
- [`docs/blueprint_correccion.md`](docs/blueprint_correccion.md) — descripción del modelo
  ...
  [HTML autocontenida](docs/blueprint_correccion.html). Es el documento para empezar.
- [`docs/flujo_grading_algebra_lineal.md`](docs/flujo_grading_algebra_lineal.md) — diseño
  técnico completo (fases, scores, códigos de excepción E1–E14, stack).
- [`docs/pipeline.md`](docs/pipeline.md) — diagrama operativo rápido.
...
1. Claves de API en `.env` (Anthropic; la de Google es opcional, habilita la segunda
   lectura).
2. Escaneos a 300 dpi en `01_escaneos/`, un archivo por estudiante.
3. Ejecutar la orquestación: `python -m scripts.orquestacion --vision`. La corrida es
   reanudable y permite re-correr estudiantes puntuales.
4. Los reportes quedan en `05_salidas/`, con las fichas por pregunta en las colas
